    ...
    var Jaco = (function () {
        ...
        */
        Jaco.prototype.removeUnpairedSurrogate = function () {
            this.remove(new RegExp('[^' + jaco.HIGH_SURROGATE + '][' + jaco.LOW_SURROGATE + ']|[' + jaco.HIGH_SURROGATE + '][^' + jaco.LOW_SURROGATE + ']', 'g'));
            return this;
        };
        /**
        * 該当の文字だけで構成されているかどうか
        ...
        */
        Jaco.prototype.convertIterationMarks = function () {
            var kanaWithIterationMarks = new RegExp('([' + jaco.HIRAGANA_CHARS_IGNORE_ITERATION_MARKS + jaco.KATAKANA_CHARS_IGNORE_ITERATION_MARKS + '])([ゝゞヽヾ])');
            var conv = function (_str) {
